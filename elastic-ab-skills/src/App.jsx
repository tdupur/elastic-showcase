...
import WhatIsSkillsScene from './scenes/WhatIsSkillsScene'
import HowSkillsWorkScene from './scenes/HowSkillsWorkScene'
import BuiltInSkillsScene from './scenes/BuiltInSkillsScene'
import CustomSkillsScene from './scenes/CustomSkillsScene'
...
const scenes = [
  ...
  { id: 'challenge', component: ChallengeScene, title: 'The Problem', description: 'Why skills exist and what pain they solve', duration: '2 min' },
  { id: 'what-is-skills', component: WhatIsSkillsScene, title: 'What Is a Skill?', description: 'Core concept: knowledge content, tools, and on-demand loading', duration: '3 min' },
  { id: 'how-skills-work', component: HowSkillsWorkScene, title: 'How Skills Work', description: 'Dynamic skill selection and activation flow', duration: '3 min' },
  { id: 'builtin-skills', component: BuiltInSkillsScene, title: 'Built-in Skills', description: 'Platform, Observability, Security, and Elasticsearch skills', duration: '4 min' },
  { id: 'custom-skills', component: CustomSkillsScene, title: 'Custom Skills', description: 'Author, deploy, and manage your own domain skills', duration: '4 min' },
  { id: 'next-steps', component: NextStepsScene, title: 'Next Steps', description: 'Try Agent Builder, read the docs, or talk to your team' },
]
