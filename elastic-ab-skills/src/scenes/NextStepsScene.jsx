...
import { faArrowRight, faArrowLeft, faBook, faRocket, faComments, faCirclePlay, faGear } from '@fortawesome/free-solid-svg-icons'
...
const actions = [
  {
    icon: faRocket,
    color: '#48EFCF',
    title: 'Try Agent Builder',
    description: 'Start building AI agents with Skills on Elastic Serverless. Free trial available.',
  ...
  },
  {
    ...
    description: 'Deep-dive into how skills work, built-in skill reference, and skill creation guidelines.',
    cta: 'View Docs',
    url: 'https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/skills',
  },
  {
    icon: faGear,
    color: '#FEC514',
    title: 'Custom Skills Guide',
    description: 'Learn how to author, test, and deploy custom skills tailored to your domain workflows.',
    cta: 'Read Guide',
    url: 'https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/custom-skills',
  },
  {
    icon: faComments,
    color: '#F04E98',
    title: 'Talk to Your Elastic Team',
    description: 'Your Elastic team can help you design custom skills and agents for your use case.',
    cta: 'Contact Us',
    url: null,
  },
  {
    ...
    description: 'Walk through Agent Builder Skills interactively. Set the URL via Settings → Click-Through Demo URL.',
    cta: 'Launch Demo',
    url: '__DEMO_URL__',
  },
]
