...
function HeroScene() {
  ...
  const questionText = "AutoOps via Cloud Connect"
        ...
        <AnimatePresence mode="wait">
          {!showAnswer ? (
            ...
            >
              ...
              >
                <span className={isDark ? 'text-white' : 'text-elastic-dark-ink'}>AutoOps via</span>
                <br />
                <motion.span
              ...
              >
                Automated cluster intelligence for ECE, ECK, and self-managed Elasticsearch
              </motion.p>
              ...
              >
                {['Free Across All License Types', 'ES 7.17+', 'Real-Time Root-Cause Analysis'].map((badge, i) => (
                  <motion.span
                    key={badge}
