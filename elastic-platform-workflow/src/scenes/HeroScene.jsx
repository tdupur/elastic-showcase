...
const SHOWCASE_SEARCH_TEXT = 'Elastic Platform Workflows'

const SHOWCASE_TITLE_LINE1 = 'Platform'
const SHOWCASE_TITLE_LINE2 = 'Workflows'
const SHOWCASE_SUBTITLE = 'Turn data insights into automated outcomes — without leaving Elastic.'
const SHOWCASE_BADGES = ['YAML-Defined', 'Kibana Native', 'AI-Ready', 'No External Tools']
