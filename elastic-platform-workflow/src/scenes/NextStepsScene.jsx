...
const actions = [
  {
    ...
    description: 'Follow the hands-on tutorial to create and run your first workflow using sample data in Kibana.',
    cta: 'Get Started',
    url: 'https://www.elastic.co/docs/explore-analyze/workflows/get-started/build-your-first-workflow',
  },
  {
    icon: faBook,
    color: '#0B64DD',
    title: 'Workflows Documentation',
    description: 'Explore triggers, steps, authoring techniques, templates, and full YAML reference.',
    cta: 'View Docs',
  ...
  },
  {
    ...
    description: 'Your Elastic team can help you design workflows for your security, observability, or AI use cases.',
    cta: 'Contact Us',
    url: null,
  },
  {
    ...
    description: 'Walk through Platform Workflows interactively at your own pace. Set the URL via Settings → Click-Through Demo URL.',
    cta: 'Launch Demo',
    url: '__DEMO_URL__',
  },
]
