...
import DeploymentOverviewScene from './scenes/DeploymentOverviewScene'
import SharedResponsibilityScene from './scenes/SharedResponsibilityScene'
import FeatureComparisonScene from './scenes/FeatureComparisonScene'
import WhenToChooseScene from './scenes/WhenToChooseScene'
...
const scenes = [
  ...
  { id: 'challenge', component: ChallengeScene, title: 'The Problem', description: 'Why choosing the wrong model costs you', duration: '3 min' },
  { id: 'deployment-overview', component: DeploymentOverviewScene, title: 'Deployment Overview', description: 'Three ways to run Elastic — at a glance', duration: '4 min' },
  { id: 'shared-responsibility', component: SharedResponsibilityScene, title: 'Shared Responsibility', description: 'Who owns what across each deployment type', duration: '5 min' },
  { id: 'feature-comparison', component: FeatureComparisonScene, title: 'Feature Comparison', description: 'What features are available where', duration: '5 min' },
  { id: 'when-to-choose', component: WhenToChooseScene, title: 'When to Choose Each', description: 'Decision guide for each deployment model', duration: '4 min' },
  { id: 'next-steps', component: NextStepsScene, title: 'Next Steps', description: 'Start your trial or talk to your Elastic team', duration: '2 min' },
]
