...
const SHOWCASE_TITLE_LINE1 = 'Elastic Deployment'
const SHOWCASE_TITLE_LINE2 = 'Options Compared'
const SHOWCASE_SUBTITLE = 'Self-Managed, Cloud Hosted, or Serverless — understand the responsibilities, features, and trade-offs so you can choose with confidence.'
const SHOWCASE_BADGES = ['Self-Managed', 'Cloud Hosted', 'Serverless']
