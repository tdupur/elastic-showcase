...
const FALLBACK_DEMO_URL = 'https://elastic.navattic.com/'
...
const actions = [
  {
    ...
    description: 'Spin up an Elasticsearch Serverless project in minutes — no infrastructure to manage.',
    cta: 'Get Started',
  ...
  },
  {
    icon: faBook,
    color: '#0B64DD',
    title: 'Project Settings Docs',
    description: 'Configure Search Power, Search Boost Window, and data retention for your serverless project.',
    cta: 'View Docs',
    url: 'https://www.elastic.co/docs/deploy-manage/deploy/elastic-cloud/project-settings',
  },
  {
    icon: faComments,
    color: '#F04E98',
    title: 'Talk to Your Elastic Team',
    description: 'Your Elastic team can help you plan your serverless migration and architecture.',
    cta: 'Contact Us',
    url: null,
  },
  {
    ...
    description: 'Walk through Search AI Serverless interactively at your own pace. Set the URL via Settings → Click-Through Demo URL.',
    cta: 'Launch Demo',
    url: '__DEMO_URL__',
  },
]
