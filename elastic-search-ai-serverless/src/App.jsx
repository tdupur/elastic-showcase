...
import WhatIsXScene from './scenes/WhatIsXScene'
import ArchitectureScene from './scenes/ArchitectureScene'
import SearchPowerScene from './scenes/SearchPowerScene'
...
const scenes = [
  ...
  { id: 'challenge', component: ChallengeScene, title: 'The Problem', description: 'Why serverless search matters', duration: '3 min' },
  { id: 'what-is-x', component: WhatIsXScene, title: 'What Is Search AI Serverless', description: 'Fully managed Elasticsearch explained', duration: '4 min' },
  { id: 'architecture', component: ArchitectureScene, title: 'Architecture', description: 'Search AI Lake & separated compute', duration: '4 min' },
  { id: 'search-power', component: SearchPowerScene, title: 'Search Power Settings', description: 'On-demand, Performant, High-throughput', duration: '5 min' },
  { id: 'capabilities', component: CapabilitiesScene, title: 'Capabilities', description: 'Vector search, ELSER, ES|QL, AI Playground', duration: '4 min' },
  { id: 'next-steps', component: NextStepsScene, title: 'Next Steps', description: 'Start your serverless journey' },
]
