...
const FALLBACK_DEMO_URL = 'https://www.elastic.co/security'
...
const actions = [
  {
    ...
    description: 'Get Elastic Security running in minutes on Elastic Cloud — no credit card required.',
  ...
  },
  {
    icon: faBook,
    color: '#0B64DD',
    title: 'Read the Security Docs',
    description: 'Full documentation for SIEM, XDR, detection rules, AI Assistant, and Elastic Workflows.',
    cta: 'View Docs',
  ...
  },
  {
    ...
    description: 'Your Elastic team can walk you through a tailored demo and help plan your security journey.',
    cta: 'Contact Us',
    url: null,
  },
  {
