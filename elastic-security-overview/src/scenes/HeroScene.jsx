...
const SHOWCASE_SEARCH_TEXT = 'Elastic Security'

const SHOWCASE_TITLE_LINE1 = 'Elastic'
const SHOWCASE_TITLE_LINE2 = 'Security'
const SHOWCASE_SUBTITLE = 'The agentic security operations platform — SIEM, XDR, and AI-powered defense, unified on one open platform.'
const SHOWCASE_BADGES = ['SIEM + XDR + EDR', 'AI-Powered', 'Forrester Wave Leader 2025']
