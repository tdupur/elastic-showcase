...
const SHOWCASE_TITLE_LINE1 = 'Elastic Cloud'
const SHOWCASE_TITLE_LINE2 = 'Serverless'
const SHOWCASE_SUBTITLE = 'Fully managed, autoscaled Elasticsearch — zero infrastructure, pure insight.'
const SHOWCASE_BADGES = ['Zero Cluster Management', 'Autoscaled by Default', 'Usage-Based Pricing']
